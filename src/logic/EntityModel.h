...
public:
    ...
    PlayerModel(int x, int y): EntityModel(x, y), vh(0), vv(0), a(0), g(1), maxVh(3), maxVv(5){};

    void update(bool floorCollision, bool ceilingCollision, bool leftWallCollision, bool rightWallCollision);
    void moveLeft();
    void moveRight();
    void moveUp();
    void jump();
